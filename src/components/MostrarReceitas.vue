...
export default {
  ...
  async created() {
    ...
    //Lógica da busca de receitas
    this.receitasEncontradas = receitas.filter((receitas)=> {
      //Todos os ingredientes de uma receita devem estar inclusos na lista de ingredientes
      // Se sim, retornar 'true'

      const possoFazerReceitas = itensDeLista1EstaoEmLista2(receitas.ingredientes, this.ingredientes) 
