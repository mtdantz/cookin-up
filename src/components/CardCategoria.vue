...
<template>
    <article class="categoria">
        ...
        <ul class="categoria__ingredientes">
            ...
            <IngredienteSelecionavel :ingrediente="ingrediente" @adicionar-ingrediente="$emit('adicionarIngrediente',$event)" @removerIngrediente="$emit('removerIngrediente', $event)"/>
            </li>
        </ul>
    </article>
</template>
